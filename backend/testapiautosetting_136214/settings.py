"""
Django settings for testapiautosetting_136214 project.
...
ROOT_URLCONF = 'testapiautosetting_136214.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136214.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettings2z1bb Support <support@testapiautosetting-136214.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136214 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136214 App",
    "VERSION": "v1",
}
